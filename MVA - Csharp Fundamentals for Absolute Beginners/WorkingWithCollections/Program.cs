...
namespace WorkingWithCollections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            myList.Add(car1);
            myList.Add(car2);
            //myList.Add(b1); Will not work since it is from a different class
            ...
            Car car4 = new Car() { Make = "Toyota", Model = "yaris", VIN = "D4" };
